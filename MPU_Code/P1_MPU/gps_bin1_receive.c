 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Mar 16 13:21:02 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME gps_bin1_receive
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        u0
#define INPUT_0_WIDTH         64
...
extern void gps_bin1_receive_Outputs_wrapper(const uint8_T *u0,
			const uint8_T *u1,
			real_T *y0,
			real_T *y1,
			void **pW);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *u1 = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *y1 = (real_T *) ssGetOutputPortRealSignal(S, 1);

    gps_bin1_receive_Outputs_wrapper(u0, u1, y0, y1, pW);
